...
describe AvaliacaosController do
  ...
  describe "GET index" do
    it "assigns all avaliacaos as @avaliacaos" do
      ...
      assigns(:avaliacaos).should eq([avaliacao])
    end
  end
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved avaliacao as @avaliacao" do
        ...
        post :create, {:avaliacao => {}}, valid_session
        assigns(:avaliacao).should be_a_new(Avaliacao)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested avaliacao" do
        avaliacao = Avaliacao.create! valid_attributes
        # Assuming there are no other avaliacaos in the database, this
        # specifies that the Avaliacao created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        Avaliacao.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
        put :update, {:id => avaliacao.to_param, :avaliacao => {'these' => 'params'}}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the avaliacao as @avaliacao" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Avaliacao.any_instance.stub(:save).and_return(false)
        put :update, {:id => avaliacao.to_param, :avaliacao => {}}, valid_session
        assigns(:avaliacao).should eq(avaliacao)
      end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the avaliacaos list" do
      avaliacao = Avaliacao.create! valid_attributes
      delete :destroy, {:id => avaliacao.to_param}, valid_session
      response.should redirect_to(avaliacaos_url)
    end
  end
