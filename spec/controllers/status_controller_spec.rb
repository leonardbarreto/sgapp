...
describe StatusController do
  ...
  # StatusController. Be sure to keep this updated too.
  def valid_session
    {}
  end

  describe "GET index" do
    it "assigns all status as @status" do
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested status" do
        status = Status.create! valid_attributes
        # Assuming there are no other status in the database, this
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the status list" do
      status = Status.create! valid_attributes
      delete :destroy, {:id => status.to_param}, valid_session
      response.should redirect_to(status_index_url)
    end
  end
