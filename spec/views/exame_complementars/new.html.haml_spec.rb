...
describe "exame_complementars/new" do
  before(:each) do
    assign(:exame_complementar, stub_model(ExameComplementar,
      :glicose => "9.99",
      :tsh => "9.99",
      :b12 => "9.99",
      :acido_folico => "9.99",
  ...
  it "renders new exame_complementar form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => exame_complementars_path, :method => "post" do
